...
Ahora se puede observar como la significancia de las variables realmente decae con el grupo de la 3ª edad, siendo alta para el resto, lo que, si se compara con el resultado anterior, tiene su origen en que el grupo de la 3ª edad en su inmensa mayoría se clasifican como no supervivientes, de ahí que apenas presente significancia.
